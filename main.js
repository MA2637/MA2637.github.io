...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var obs = this.http.get('http://api.github.com/users/MA2637');
        //let obs = this.http.get('http://ec2-34-210-26-240.us-west-2.compute.amazonaws.com:8080/retreiver')
        obs.subscribe(function () { return console.log('Got the response'); });
    };
...
module.exports = "<h2>Search</h2>\n<form>\n  <!--Quotes=\"query\" used to be name=\"query\"-->\n  <input type=\"search\" name=\"query\" [(ngModel)]=\"query\" (keyup.enter)=\"search()\">\n  <button type=\"button\" (click)=\"search()\">Search</button>\n</form>\n<table *ngIf=\"searchResults\">\n  <thead>\n  <tr>\n    <!--<th>Name</th>-->\n    <th>Results</th>\n    <th>Citation</th>\n    <!--<th>Phone</th>-->\n    <!--<th>Address</th>-->\n  </tr>\n  </thead>\n  <tbody>\n  <!--<td><tr *ngFor=\"let person of searchResults; let i=index\"></td>-->\n  <tr *ngFor=\"let q of searchResults; let i=index\">\n    <!--<td>{{q.result}}</td>--><td>\n    <td>{{q.quote}}</td>\n    <td>{{q.citation}}</td>\n    <!--<td>{{person.phone}}</td>-->\n    <!--<td>{{person.address.street}}<br/>\n      {{person.address.city}}, {{person.address.state}} {{person.address.zip}}\n    </td>-->\n  </tr>\n  </tbody>\n</table>\n\n"
...
var SearchComponent = /** @class */ (function () {
    ...
    SearchComponent.prototype.search = function () {
        ...
        function (retriever) { _this.searchResults = retriever; }, function (error) { return console.log(error); });
    };
    __decorate([
...
/*!*********************************!*\
  !*** ./src/app/shared/index.ts ***!
  \*********************************/
/*! exports provided: SearchService, Quotes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Quotes", function() { return _search_search_service__WEBPACK_IMPORTED_MODULE_0__["Quotes"]; });
